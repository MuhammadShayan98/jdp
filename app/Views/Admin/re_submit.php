...
<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - In Review </h4>
...
<span class="breadcrumb-item active">In Review</span>
...
Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently</textarea>
            ...
            <div class="form-group">
                ...
                <textarea rows="5" cols="5" name="reason_for_rejection" class="form-control" placeholder="Enter your Reason here">
Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </textarea>
            ...
            <div class="form-group">
                <label>Tentative Re-submission Date:</label>
                <input type="text" name="Tentative_resubmission_date" class="form-control" placeholder="Enter  here">
            ...
            <div class="form-group row mb-0 mt-5">
                <div class="col-lg-10 ml-lg-auto">
                    <button type="submit" class="btn bg-blue ml-3">Re-Submit <i class="icon-paperplane ml-2"></i></button>
